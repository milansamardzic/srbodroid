...
public class DataLoader<T>
{
    ...
    /**
     * @param listener optional {@link com.srbodroid.rsb.data.DataLoader.LoadListener}
     ...
     * Providers are used in order they are placed in a list, make sure that you place providers with higher priority first<br><br>
     * Result will be delivered in {@link com.srbodroid.rsb.data.DataLoader.LoadListener#onLoadingFinished(com.srbodroid.rsb.data.DataLoader.Result)}
