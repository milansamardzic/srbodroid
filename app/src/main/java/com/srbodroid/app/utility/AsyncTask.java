 ...
 * Modified by Predrag Čokulov to support parallel execution
 */
public abstract class AsyncTask<Params, Progress, Result>
{
    ...
    public enum Status
    {
        ...
        RUNNING,
        /**
         * Indicates that {@link com.srbodroid.app.utility.AsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
    ...
    public AsyncTask()
    {
        ...
        mFuture = new FutureTask<Result>(mWorker)
        {
            ...
            protected void done()
            {
                ...
                {
                    if(BuildConfig.DEBUG)android.util.Log.w(LOG_TAG, e);
                }
     ...
     *                               {@link com.srbodroid.app.utility.AsyncTask.Status#RUNNING} or {@link com.srbodroid.app.utility.AsyncTask.Status#FINISHED}.
     */
