...
public class MyTimer
{
    ...
    {
        if(Constants.LOGGING) Log.d(Constants.LOG_TAG, message + get());
    }

    public void logAvg(String message)
    {
        if(Constants.LOGGING) Log.d(Constants.LOG_TAG, message + avg());
    }

    public void logTotal(String message)
    {
        if(Constants.LOGGING) Log.d(Constants.LOG_TAG, message + total());
    }
}
